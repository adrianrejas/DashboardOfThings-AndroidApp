...
public class NetworkDetailsLogsFragment extends Fragment {
    /**
    ...
    private NetworkDetailsLogsFragment.LogsListAdapter mAdapter;
    ...
    private void configureListAdapter() {
        ...
        // Configure adapter for recycler view
        mAdapter = new NetworkDetailsLogsFragment.LogsListAdapter();
    ...
    class LogsListAdapter extends RecyclerView.Adapter<NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder> {
        ...
        @Override
        public NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            CardLogBinding binding = DataBindingUtil.inflate(inflater, R.layout.card_log,
                    parent, false);
            return new NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder(binding);
        }

        @Override
        public void onBindViewHolder(final NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder holder, int position) {
