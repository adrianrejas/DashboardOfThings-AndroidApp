...
class SensorDetailsLogsFragment : Fragment() {

    internal var uiBinding: FragmentSensorDetailsLogsBinding? = null
    ...
    private var mAdapter: SensorDetailsLogsFragment.LogsListAdapter? = null
    ...
    override fun onCreateView(
        ...
        uiBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_sensor_details_logs,
            container,
            false
        )
    ...
    private fun configureListAdapter() {
        ...
        uiBinding!!.logsSensorDetailsListLayout.mainList.layoutManager = llm_linear

        // Configure adapter for recycler view
        mAdapter = SensorDetailsLogsFragment.LogsListAdapter()
        uiBinding!!.logsSensorDetailsListLayout.mainList.adapter = mAdapter
    }
    ...
    private fun showError() {
        if (uiBinding != null) {
            uiBinding!!.logsSensorDetailsListLayout.listLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsErrorLayout.errorLayout.visibility = View.VISIBLE
            uiBinding!!.logsSensorDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsErrorLayout.tvError.text =
    ...
    private fun showLoading() {
        if (uiBinding != null) {
            uiBinding!!.logsSensorDetailsListLayout.listLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsLoadingLayout.loadingLayout.visibility = View.VISIBLE
            uiBinding!!.logsSensorDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
        }
    }
    ...
    private fun showNoElements() {
        if (uiBinding != null) {
            ...
            uiBinding!!.logsSensorDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsNoElementsLayout.noElementsLayout.visibility = View.VISIBLE
        }
    }
    ...
    private fun showList() {
        if (uiBinding != null) {
            uiBinding!!.logsSensorDetailsListLayout.listLayout.visibility = View.VISIBLE
            uiBinding!!.logsSensorDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsSensorDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
        }
    ...
    internal inner class LogsListAdapter :
        RecyclerView.Adapter<SensorDetailsLogsFragment.LogsListAdapter.LogListViewHolder>() {
        ...
        override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
        ): SensorDetailsLogsFragment.LogsListAdapter.LogListViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = DataBindingUtil.inflate<CardLogBinding>(
                inflater, R.layout.card_log,
                parent, false
            )
            return SensorDetailsLogsFragment.LogsListAdapter.LogListViewHolder(binding)
        }

        override fun onBindViewHolder(
            holder: SensorDetailsLogsFragment.LogsListAdapter.LogListViewHolder,
            position: Int
        ) {
