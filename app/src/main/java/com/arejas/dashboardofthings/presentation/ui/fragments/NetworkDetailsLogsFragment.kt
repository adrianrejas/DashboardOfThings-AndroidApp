...
class NetworkDetailsLogsFragment : Fragment() {

    internal var uiBinding: FragmentNetworkDetailsLogsBinding? = null
    ...
    private var mAdapter: NetworkDetailsLogsFragment.LogsListAdapter? = null
    ...
    override fun onCreateView(
        ...
        uiBinding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_network_details_logs,
            container,
            false
        )
    ...
    private fun configureListAdapter() {
        ...
        uiBinding!!.logsNetworkDetailsListLayout.mainList.layoutManager = llm_linear

        // Configure adapter for recycler view
        mAdapter = NetworkDetailsLogsFragment.LogsListAdapter()
        uiBinding!!.logsNetworkDetailsListLayout.mainList.adapter = mAdapter
    }
    ...
    private fun showError() {
        if (uiBinding != null) {
            uiBinding!!.logsNetworkDetailsListLayout.listLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsErrorLayout.errorLayout.visibility = View.VISIBLE
            uiBinding!!.logsNetworkDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsErrorLayout.tvError.text =
    ...
    private fun showLoading() {
        if (uiBinding != null) {
            uiBinding!!.logsNetworkDetailsListLayout.listLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsLoadingLayout.loadingLayout.visibility = View.VISIBLE
            uiBinding!!.logsNetworkDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
        }
    }
    ...
    private fun showNoElements() {
        if (uiBinding != null) {
            ...
            uiBinding!!.logsNetworkDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsNoElementsLayout.noElementsLayout.visibility =
                View.VISIBLE
        }
    }
    ...
    private fun showList() {
        if (uiBinding != null) {
            uiBinding!!.logsNetworkDetailsListLayout.listLayout.visibility = View.VISIBLE
            uiBinding!!.logsNetworkDetailsLoadingLayout.loadingLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsErrorLayout.errorLayout.visibility = View.GONE
            uiBinding!!.logsNetworkDetailsNoElementsLayout.noElementsLayout.visibility = View.GONE
        }
    ...
    internal inner class LogsListAdapter :
        RecyclerView.Adapter<NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder>() {
        ...
        override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
        ): NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = DataBindingUtil.inflate<CardLogBinding>(
                inflater, R.layout.card_log,
                parent, false
            )
            return NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder(binding)
        }

        override fun onBindViewHolder(
            holder: NetworkDetailsLogsFragment.LogsListAdapter.LogListViewHolder,
            position: Int
        ) {
